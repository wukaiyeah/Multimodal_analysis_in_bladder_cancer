...
SUMMARY_TITLE_FONT_PATH = fm.findfont(fm.FontProperties(family='DejaVu Sans'))
...
def generate_tile_summaries(tile_sum, np_img, display=False, save_summary=False):
  """
...
def generate_top_tile_summaries(tile_sum, np_img, display=False, save_summary=False, show_top_stats=True,

...
if __name__ == '__main__':
    ...
    # split data
    X_test, y_test, test_index = data_split(x_features, y_label, args)

    # initialize model
    net1 = torch.load(os.path.join(data_dir,'net_0_fold0.pth'))
    net2 = torch.load(os.path.join(data_dir,'net_wsi_fold0.pth'))
    net3 = torch.load(os.path.join(data_dir,'net_ct_fold0.pth'))
    ...
    pred_res.to_csv(os.path.join(data_dir,'mol_subtype_pred_res_multi_nets.csv'))

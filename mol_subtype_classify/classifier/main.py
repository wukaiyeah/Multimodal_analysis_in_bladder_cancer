...
def gen_parser():
    ...
    parser.add_argument('--fold', type=int, default=3, help='[0,1,2,3,4]')
...
if __name__ == '__main__':
    ...
    # load dataset
    datatable = pd.read_csv('/media/wukai/Data01/Multimodal_analysis_in_bladder_cancer/mol_subtype_classify/classifier/dataset_for_classifer.csv',index_col=0, header=0)
    ...
    for epoch in range(args.epochs):
        ...
        #    best_acc = accuracy
        #    best_auc = auc
        #    torch.save(net, '/media/wukai/Data01/Multimodal_analysis_in_bladder_cancer/mol_subtype_classify/classifier/net_0_fold%d.pth'%args.fold)
